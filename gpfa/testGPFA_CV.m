function testGPFA_CV()

% finds optimal latent state dimensionality

close all;
addpath(genpath('C:\Users\labadmin\Desktop\gpfa\gpfa_v0203'));
...
for xDim = 1:20
    neuralTraj(runIdx, dat, 'method', method, 'xDim', xDim,...
