...
[Q,~,P,~,~] = orthogonal_subspaces(data.Cmove,d_Move,data.Cprep,d_Prep,alpha);
P1 = P{1}; % Q*P1 = Qmove
P2 = P{2}; % Q*P2 = Qprep
...
var_explained(Q,P1,P2,data.Cmove,data.Cprep,d_Move,d_Prep,dmax);
...
Q_prep = Q*P2;
% 
% left_move = data.psth_left*Q_move;
% right_move = data.psth_right*Q_move;
% left_prep = data.psth_left*Q_prep;
% right_prep = data.psth_right*Q_prep;
...
% 
% full_left_move = data.psth_int{1}*Q_move;
% full_right_move = data.psth_int{2}*Q_move;
% full_left_prep = data.psth_int{1}*Q_prep;
% full_right_prep = data.psth_int{2}*Q_prep;
