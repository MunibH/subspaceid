function plotStateSpace(time, psth, rez, cols, methodName, dims)
...
for i = 1:size(dat.toPlot,3)
    p(i) = plot3(dat.toPlot(:,1,i), dat.toPlot(:,2,i),...
             dat.toPlot(:,3,i), 'LineWidth', 2);
    plot3(dat.toPlot(gocueidx,1,i), dat.toPlot(gocueidx,2,i),...
             dat.toPlot(gocueidx,3,i), '.', 'Color', cols{i}, 'MarkerSize',30);
end
hold off
grid on
xlabel(lbl{1})
