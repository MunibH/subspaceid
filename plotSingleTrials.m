...
for i = 1:numel(condnum)
    p(1:numel(trials{condnum(i)}),i) = ...
           plot3(mySmooth(dat.toPlot(:,trials{condnum(i)},1),smth), ...
                 mySmooth(dat.toPlot(:,trials{condnum(i)},2),smth), ...
                 mySmooth(dat.toPlot(:,trials{condnum(i)},3),smth), ... 
                 'LineWidth', 0.5, ...
...
for i = 1:numel(condnum)
    ...
    for j = 1:numel(trials{condnum(i)})
